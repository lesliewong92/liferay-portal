 ...
 */
@Generated("")
public interface IndividualSegmentMembershipChangeMetricResource {
	...
	public static class Builder {
		...
		public IndividualSegmentMembershipChangeMetricResource build() {
			return new IndividualSegmentMembershipChangeMetricResourceImpl(
				this);
		}
	...
	public static class IndividualSegmentMembershipChangeMetricResourceImpl
		implements IndividualSegmentMembershipChangeMetricResource {
		...
		public IndividualSegmentMembershipChangeMetric
			...
			try {
				return IndividualSegmentMembershipChangeMetricSerDes.toDTO(
					content);
			}
			catch (Exception e) {
				_logger.log(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/workspace/{groupId}/individual-segments/{individualSegmentId}/membership-change-metrics");
		...
		private IndividualSegmentMembershipChangeMetricResourceImpl(
			Builder builder) {
		...
		private static final Logger _logger = Logger.getLogger(
			IndividualSegmentMembershipChangeMetricResource.class.getName());
