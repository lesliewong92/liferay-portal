...
public abstract class BaseIndividualResourceTestCase {
	...
	public void testGetWorkspaceGroupIndividualsPage() throws Exception {
		...
		if (irrelevantGroupId != null) {
			...
			page = individualResource.getWorkspaceGroupIndividualsPage(
				irrelevantGroupId, null, null, null, null, null, null, null,
				null, null, null, Pagination.of(1, (int)totalCount + 1), null);
		...
		page = individualResource.getWorkspaceGroupIndividualsPage(
			groupId, null, null, null, null, null, null, null, null, null, null,
	...
	public void testGetWorkspaceGroupIndividualsPageWithPagination()
		...
		Page<Individual> individualsPage =
			individualResource.getWorkspaceGroupIndividualsPage(
				groupId, null, null, null, null, null, null, null, null, null,
				null, null, null);
...
// LIFERAY-REST-BUILDER-HASH:-2119028983