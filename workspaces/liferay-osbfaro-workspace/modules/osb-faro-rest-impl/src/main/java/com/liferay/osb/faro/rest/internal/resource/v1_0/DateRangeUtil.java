...
/**
 * Converts the REST date-range parameters into the {@code Date} pair the
 * engine client's date-bounded calls take. A range key wins over an explicit
 * start and end, as it does everywhere else in this API.
 *
 * @author Leslie Wong
 */
public class DateRangeUtil {

	public static Date getEndDate(String rangeKey, String rangeEnd) {
