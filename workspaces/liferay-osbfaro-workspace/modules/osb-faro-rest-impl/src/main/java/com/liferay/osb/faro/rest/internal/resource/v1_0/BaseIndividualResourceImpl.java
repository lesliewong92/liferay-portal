...
public abstract class BaseIndividualResourceImpl
	implements EntityModelResource, IndividualResource {
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/workspace/{groupId}/channels/{channelId}/individuals")
	...
	public Page<Individual> getWorkspaceGroupChannelIndividualsPage(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("individualSegmentId")
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				description = "ID of the individual to fetch.",
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
				name = "individualId"
			),
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/workspace/{groupId}/individuals/{individualId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/workspace/{groupId}/individuals'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "List individuals for an Analytics Cloud workspace. Optionally narrowed to an associated account, channel, individual segment, interest, activity status, or date range, and searchable by name or email with `search`. Use this to answer 'who is in this segment' or 'who engaged recently' style questions. To fetch a single individual by ID, use `getWorkspaceGroupIndividual` instead. To read an individual segment's membership records, which also cover individuals who have left the segment, use `getWorkspaceGroupIndividualSegmentMembershipsPage`."
	)
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/workspace/{groupId}/individuals")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
...
// LIFERAY-REST-BUILDER-HASH:-1989112