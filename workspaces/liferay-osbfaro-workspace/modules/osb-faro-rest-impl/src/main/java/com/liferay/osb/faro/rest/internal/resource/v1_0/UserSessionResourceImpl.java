...
public class UserSessionResourceImpl extends BaseUserSessionResourceImpl {
	...
	private Page<UserSession> _getUserSessionsPage(
		...
		// The backend reports the total number of events but not the total
		// number of sessions, so the page total is the lowest count that is
		// consistent with this page: one more than what has been seen when the
		// page is full, which tells clients that another page may exist
