...
public abstract class BaseIndividualSegmentMembershipChangeMetricResourceImpl
	...
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			...
			@io.swagger.v3.oas.annotations.Parameter(
				description = "ID of the individual segment whose membership should be measured.",
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.PATH,
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "IndividualSegmentMembershipChangeMetric"
			)
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/workspace/{groupId}/individual-segments/{individualSegmentId}/membership-change-metrics"
	)
