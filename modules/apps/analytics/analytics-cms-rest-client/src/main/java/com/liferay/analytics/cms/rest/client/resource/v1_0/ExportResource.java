...
public interface ExportResource {
	...
	public void getPerformanceMetricViewsByCategorizationExport(
			Long[] depotEntryIds, Integer rangeKey)
		throws Exception;

	public HttpInvoker.HttpResponse
			getPerformanceMetricViewsByCategorizationExportHttpResponse(
				Long[] depotEntryIds, Integer rangeKey)
		throws Exception;

	public void getPerformanceMetricViewsByLocationExport(
			Long[] depotEntryIds, Integer rangeKey)
		throws Exception;

	public HttpInvoker.HttpResponse
			getPerformanceMetricViewsByLocationExportHttpResponse(
				Long[] depotEntryIds, Integer rangeKey)
		throws Exception;
	...
	public static class Builder {
		...
		public ExportResource build() {
			return new ExportResourceImpl(this);
		}
	...
	public static class ExportResourceImpl implements ExportResource {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-cms-rest/v1.0/performance-metric-views-by-categorization/export");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-cms-rest/v1.0/performance-metric-views-by-location/export");
		...
		private ExportResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			ExportResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-1047708491