...
public abstract class BaseChannelResourceTestCase {
	...
	@Test
	public void testGetSiteChannel() throws Exception {
		Channel postChannel = testGetSiteChannel_addChannel();

		Channel getChannel = channelResource.getSiteChannel(
			testGetSiteChannel_getSiteId(), postChannel.getId());

		assertEquals(postChannel, getChannel);
		assertValid(getChannel);
	}

	protected Channel testGetSiteChannel_addChannel() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetSiteChannel_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteChannel() throws Exception {
		Channel channel = testGraphQLGetSiteChannel_addChannel();
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteKey",
											"\"" +
												testGraphQLGetSiteChannel_getSiteId() +
													"\"");
										put(
											"channelId",
											"\"" + channel.getId() + "\"");
	...
	protected Long testGraphQLGetSiteChannel_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteChannelNotFound() throws Exception {
	...
	protected Channel testGraphQLGetSiteChannel_addChannel() throws Exception {
		return testGraphQLSiteChannel_addChannel();
	}

	@Test
	public void testGetSiteChannelsPage() throws Exception {
		Long siteId = testGetSiteChannelsPage_getSiteId();
		Long irrelevantSiteId = testGetSiteChannelsPage_getIrrelevantSiteId();

		Page<Channel> page = channelResource.getSiteChannelsPage(
			siteId, Pagination.of(1, 10));

		long totalCount = page.getTotalCount();

		if (irrelevantSiteId != null) {
			Channel irrelevantChannel = testGetSiteChannelsPage_addChannel(
				irrelevantSiteId, randomIrrelevantChannel());

			page = channelResource.getSiteChannelsPage(
			...
			assertValid(
				page,
				testGetSiteChannelsPage_getExpectedActions(irrelevantSiteId));
		}

		Channel channel1 = testGetSiteChannelsPage_addChannel(
			siteId, randomChannel());

		Channel channel2 = testGetSiteChannelsPage_addChannel(
			siteId, randomChannel());
		...
		assertValid(page, testGetSiteChannelsPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteChannelsPage_getExpectedActions(Long siteId)
		throws Exception {
	...
	@Test
	public void testGetSiteChannelsPageWithPagination() throws Exception {
		Long siteId = testGetSiteChannelsPage_getSiteId();

		Page<Channel> channelsPage = channelResource.getSiteChannelsPage(
			siteId, null);
		...
		Channel channel3 = testGetSiteChannelsPage_addChannel(
			siteId, randomChannel());
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			Page<Channel> page1 = channelResource.getSiteChannelsPage(
				siteId,
				Pagination.of(
			...
			Page<Channel> page2 = channelResource.getSiteChannelsPage(
				siteId,
				Pagination.of(
			...
			Page<Channel> page3 = channelResource.getSiteChannelsPage(
				siteId,
				Pagination.of(
	...
	protected Channel testGetSiteChannelsPage_addChannel(
			Long siteId, Channel channel)
		throws Exception {
	...
	protected Long testGetSiteChannelsPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetSiteChannelsPage_getIrrelevantSiteId()
		throws Exception {

		return irrelevantGroup.getGroupId();
	}

	protected Channel testGraphQLSiteChannel_addChannel() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
...
// LIFERAY-REST-BUILDER-HASH:-1621197027