...
public abstract class BaseAccountResourceTestCase {
	...
	@Test
	public void testGetSiteAccount() throws Exception {
		Account postAccount = testGetSiteAccount_addAccount();

		Account getAccount = accountResource.getSiteAccount(
			testGetSiteAccount_getSiteId(), postAccount.getId());

		assertEquals(postAccount, getAccount);
		assertValid(getAccount);
	}

	protected Account testGetSiteAccount_addAccount() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetSiteAccount_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteAccount() throws Exception {
		Account account = testGraphQLGetSiteAccount_addAccount();
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteKey",
											"\"" +
												testGraphQLGetSiteAccount_getSiteId() +
													"\"");
										put(
											"accountId",
											"\"" + account.getId() + "\"");
	...
	protected Long testGraphQLGetSiteAccount_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteAccountNotFound() throws Exception {
	...
	protected Account testGraphQLGetSiteAccount_addAccount() throws Exception {
		return testGraphQLSiteAccount_addAccount();
	}

	@Test
	public void testGetSiteAccountsPage() throws Exception {
		Long siteId = testGetSiteAccountsPage_getSiteId();
		Long irrelevantSiteId = testGetSiteAccountsPage_getIrrelevantSiteId();

		Page<Account> page = accountResource.getSiteAccountsPage(
		...
		if (irrelevantSiteId != null) {
			Account irrelevantAccount = testGetSiteAccountsPage_addAccount(
				irrelevantSiteId, randomIrrelevantAccount());

			page = accountResource.getSiteAccountsPage(
			...
			assertValid(
				page,
				testGetSiteAccountsPage_getExpectedActions(irrelevantSiteId));
		}

		Account account1 = testGetSiteAccountsPage_addAccount(
			siteId, randomAccount());

		Account account2 = testGetSiteAccountsPage_addAccount(
			siteId, randomAccount());
		...
		assertValid(page, testGetSiteAccountsPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteAccountsPage_getExpectedActions(Long siteId)
		throws Exception {
	...
	@Test
	public void testGetSiteAccountsPageWithPagination() throws Exception {
		Long siteId = testGetSiteAccountsPage_getSiteId();

		Page<Account> accountsPage = accountResource.getSiteAccountsPage(
		...
		Account account3 = testGetSiteAccountsPage_addAccount(
			siteId, randomAccount());
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			Page<Account> page1 = accountResource.getSiteAccountsPage(
				siteId, null, null,
				Pagination.of(
			...
			Page<Account> page2 = accountResource.getSiteAccountsPage(
				siteId, null, null,
				Pagination.of(
			...
			Page<Account> page3 = accountResource.getSiteAccountsPage(
				siteId, null, null,
				Pagination.of(
	...
	@Test
	public void testGetSiteAccountsPageWithSortDateTime() throws Exception {
		testGetSiteAccountsPageWithSort(
	...
	@Test
	public void testGetSiteAccountsPageWithSortDouble() throws Exception {
		testGetSiteAccountsPageWithSort(
	...
	@Test
	public void testGetSiteAccountsPageWithSortInteger() throws Exception {
		testGetSiteAccountsPageWithSort(
	...
	@Test
	public void testGetSiteAccountsPageWithSortString() throws Exception {
		testGetSiteAccountsPageWithSort(
	...
	protected void testGetSiteAccountsPageWithSort(
		...
		account1 = testGetSiteAccountsPage_addAccount(siteId, account1);

		account2 = testGetSiteAccountsPage_addAccount(siteId, account2);

		Page<Account> page = accountResource.getSiteAccountsPage(
			siteId, null, null, null, null);

		for (EntityField entityField : entityFields) {
			Page<Account> ascPage = accountResource.getSiteAccountsPage(
				siteId, null, null,
			...
			Page<Account> descPage = accountResource.getSiteAccountsPage(
				siteId, null, null,
				Pagination.of(1, (int)page.getTotalCount() + 1),
	...
	protected Account testGetSiteAccountsPage_addAccount(
			Long siteId, Account account)
		throws Exception {
	...
	protected Long testGetSiteAccountsPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetSiteAccountsPage_getIrrelevantSiteId()
		throws Exception {

		return irrelevantGroup.getGroupId();
	}

	protected Account testGraphQLSiteAccount_addAccount() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
...
// LIFERAY-REST-BUILDER-HASH:297146188