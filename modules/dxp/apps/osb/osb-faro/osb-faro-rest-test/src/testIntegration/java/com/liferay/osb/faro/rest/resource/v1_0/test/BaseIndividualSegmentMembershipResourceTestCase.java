...
public abstract class BaseIndividualSegmentMembershipResourceTestCase {
	...
	@Test
	public void testGetSiteIndividualSegmentMembershipsPage() throws Exception {
		Long siteId = testGetSiteIndividualSegmentMembershipsPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteIndividualSegmentMembershipsPage_getIrrelevantSiteId();
		String individualSegmentId =
			testGetSiteIndividualSegmentMembershipsPage_getIndividualSegmentId();
		String irrelevantIndividualSegmentId =
			testGetSiteIndividualSegmentMembershipsPage_getIrrelevantIndividualSegmentId();

		Page<IndividualSegmentMembership> page =
			individualSegmentMembershipResource.
				getSiteIndividualSegmentMembershipsPage(
					siteId, individualSegmentId, Pagination.of(1, 10), null);
		...
		if ((irrelevantSiteId != null) &&
			...
			IndividualSegmentMembership irrelevantIndividualSegmentMembership =
				testGetSiteIndividualSegmentMembershipsPage_addIndividualSegmentMembership(
					irrelevantSiteId, irrelevantIndividualSegmentId,
			...
			assertValid(
				page,
				testGetSiteIndividualSegmentMembershipsPage_getExpectedActions(
					irrelevantSiteId, irrelevantIndividualSegmentId));
		}

		IndividualSegmentMembership individualSegmentMembership1 =
			testGetSiteIndividualSegmentMembershipsPage_addIndividualSegmentMembership(
				siteId, individualSegmentId,
				randomIndividualSegmentMembership());
	...
	@Test
	public void testGetSiteIndividualSegmentMembershipsPageWithPagination()
		throws Exception {
		...
		Page<IndividualSegmentMembership> individualSegmentMembershipsPage =
			individualSegmentMembershipResource.
				getSiteIndividualSegmentMembershipsPage(
					siteId, individualSegmentId, null, null);
	...
	@Test
	public void testGetSiteIndividualSegmentMembershipsPageWithSortDateTime()
		throws Exception {

		testGetSiteIndividualSegmentMembershipsPageWithSort(
	...
	@Test
	public void testGetSiteIndividualSegmentMembershipsPageWithSortDouble()
		throws Exception {
	...
	@Test
	public void testGetSiteIndividualSegmentMembershipsPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetSiteIndividualSegmentMembershipsPageWithSortString()
		throws Exception {
	...
	protected void testGetSiteIndividualSegmentMembershipsPageWithSort(
		...
		individualSegmentMembership1 =
			testGetSiteIndividualSegmentMembershipsPage_addIndividualSegmentMembership(
				siteId, individualSegmentId, individualSegmentMembership1);

		individualSegmentMembership2 =
			testGetSiteIndividualSegmentMembershipsPage_addIndividualSegmentMembership(
				siteId, individualSegmentId, individualSegmentMembership2);
	...
	protected Long testGetSiteIndividualSegmentMembershipsPage_getSiteId()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:765606777