...
public abstract class BaseEventResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		event.setEmailAddressHashed(regex);
		event.setName(regex);
		...
		Assert.assertEquals(regex, event.getEmailAddressHashed());
	...
	@Test
	public void testGetSiteChannelEventsPage() throws Exception {
		Long siteId = testGetSiteChannelEventsPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteChannelEventsPage_getIrrelevantSiteId();
		String channelId = testGetSiteChannelEventsPage_getChannelId();
		String irrelevantChannelId =
			testGetSiteChannelEventsPage_getIrrelevantChannelId();

		Page<Event> page = eventResource.getSiteChannelEventsPage(
			siteId, channelId, null, RandomTestUtil.randomString(), null,
			RandomTestUtil.randomString(), null, Pagination.of(1, 10));

		long totalCount = page.getTotalCount();

		if ((irrelevantSiteId != null) && (irrelevantChannelId != null)) {
			Event irrelevantEvent = testGetSiteChannelEventsPage_addEvent(
				irrelevantSiteId, irrelevantChannelId, randomIrrelevantEvent());

			page = eventResource.getSiteChannelEventsPage(
				irrelevantSiteId, irrelevantChannelId, null, null, null, null,
			...
			assertValid(
				page,
				testGetSiteChannelEventsPage_getExpectedActions(
					irrelevantSiteId, irrelevantChannelId));
		}

		Event event1 = testGetSiteChannelEventsPage_addEvent(
			siteId, channelId, randomEvent());

		Event event2 = testGetSiteChannelEventsPage_addEvent(
			siteId, channelId, randomEvent());

		page = eventResource.getSiteChannelEventsPage(
			siteId, channelId, null, null, null, null, null,
			Pagination.of(1, 10));
		...
		assertValid(
			page,
			testGetSiteChannelEventsPage_getExpectedActions(siteId, channelId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteChannelEventsPage_getExpectedActions(
				Long siteId, String channelId)
		throws Exception {
	...
	@Test
	public void testGetSiteChannelEventsPageWithPagination() throws Exception {
		Long siteId = testGetSiteChannelEventsPage_getSiteId();
		String channelId = testGetSiteChannelEventsPage_getChannelId();

		Page<Event> eventsPage = eventResource.getSiteChannelEventsPage(
			siteId, channelId, null, null, null, null, null, null);
		...
		Event event3 = testGetSiteChannelEventsPage_addEvent(
			siteId, channelId, randomEvent());
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			Page<Event> page1 = eventResource.getSiteChannelEventsPage(
				siteId, channelId, null, null, null, null, null,
				Pagination.of(
			...
			Page<Event> page2 = eventResource.getSiteChannelEventsPage(
				siteId, channelId, null, null, null, null, null,
				Pagination.of(
			...
			Page<Event> page3 = eventResource.getSiteChannelEventsPage(
				siteId, channelId, null, null, null, null, null,
				Pagination.of(
	...
	protected Event testGetSiteChannelEventsPage_addEvent(
			Long siteId, String channelId, Event event)
		throws Exception {
	...
	protected Long testGetSiteChannelEventsPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetSiteChannelEventsPage_getIrrelevantSiteId()
		throws Exception {

		return irrelevantGroup.getGroupId();
	}

	protected String testGetSiteChannelEventsPage_getChannelId()
		throws Exception {
	...
	protected String testGetSiteChannelEventsPage_getIrrelevantChannelId()
		throws Exception {
	...
	protected void assertValid(Event event) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
					"emailAddressHashed", additionalAssertFieldName)) {

				if (event.getEmailAddressHashed() == null) {
					valid = false;
				}
	...
	protected boolean equals(Event event1, Event event2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals(
				...
				if (!Objects.deepEquals(
						event1.getEmailAddressHashed(),
						event2.getEmailAddressHashed())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("emailAddressHashed")) {
			Object object = event.getEmailAddressHashed();
...
// LIFERAY-REST-BUILDER-HASH:573864858