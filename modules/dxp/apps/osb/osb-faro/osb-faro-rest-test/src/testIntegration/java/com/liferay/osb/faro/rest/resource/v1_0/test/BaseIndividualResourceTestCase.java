...
public abstract class BaseIndividualResourceTestCase {
	...
	@Test
	public void testGetSiteIndividual() throws Exception {
		Individual postIndividual = testGetSiteIndividual_addIndividual();

		Individual getIndividual = individualResource.getSiteIndividual(
			testGetSiteIndividual_getSiteId(), postIndividual.getId(), null);

		assertEquals(postIndividual, getIndividual);
		assertValid(getIndividual);
	}

	protected Individual testGetSiteIndividual_addIndividual()
		throws Exception {
	...
	protected Long testGetSiteIndividual_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteIndividual() throws Exception {
		Individual individual = testGraphQLGetSiteIndividual_addIndividual();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteKey",
											"\"" +
												testGraphQLGetSiteIndividual_getSiteId() +
													"\"");
										put(
											"individualId",
											"\"" + individual.getId() + "\"");
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/individual"))));
	...
	protected Long testGraphQLGetSiteIndividual_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteIndividualNotFound() throws Exception {
	...
	protected Individual testGraphQLGetSiteIndividual_addIndividual()
		throws Exception {

		return testGraphQLSiteIndividual_addIndividual();
	}

	@Test
	public void testGetSiteIndividualProfile() throws Exception {
		Individual postIndividual =
			testGetSiteIndividualProfile_addIndividual();

		Individual getIndividual = individualResource.getSiteIndividualProfile(
			testGetSiteIndividualProfile_getSiteId(), postIndividual.getId());

		assertEquals(postIndividual, getIndividual);
		assertValid(getIndividual);
	}

	protected Individual testGetSiteIndividualProfile_addIndividual()
		throws Exception {
	...
	protected Long testGetSiteIndividualProfile_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteIndividualProfile() throws Exception {
		Individual individual =
			testGraphQLGetSiteIndividualProfile_addIndividual();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteKey",
											"\"" +
												testGraphQLGetSiteIndividualProfile_getSiteId() +
													"\"");
										put(
											"individualId",
											"\"" + individual.getId() + "\"");
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/individualProfile"))));
						...
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new GraphQLField(
									...
									getGraphQLFields()))),
						"JSONObject/data", "JSONObject/faro_v1_0",
						"Object/individualProfile"))));
	}

	protected Long testGraphQLGetSiteIndividualProfile_getSiteId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetSiteIndividualProfileNotFound() throws Exception {
		String irrelevantIndividualId =
			"\"" + RandomTestUtil.randomString() + "\"";
	...
	protected Individual testGraphQLGetSiteIndividualProfile_addIndividual()
		throws Exception {
	...
	@Test
	public void testGetSiteIndividualsPage() throws Exception {
		Long siteId = testGetSiteIndividualsPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteIndividualsPage_getIrrelevantSiteId();

		Page<Individual> page = individualResource.getSiteIndividualsPage(
		...
		if (irrelevantSiteId != null) {
			Individual irrelevantIndividual =
				testGetSiteIndividualsPage_addIndividual(
					irrelevantSiteId, randomIrrelevantIndividual());

			page = individualResource.getSiteIndividualsPage(
				irrelevantSiteId, null, null, null, null, null, null, null,
			...
			assertValid(
				page,
				testGetSiteIndividualsPage_getExpectedActions(
					irrelevantSiteId));
		}

		Individual individual1 = testGetSiteIndividualsPage_addIndividual(
			siteId, randomIndividual());

		Individual individual2 = testGetSiteIndividualsPage_addIndividual(
			siteId, randomIndividual());
		...
		assertValid(
			page, testGetSiteIndividualsPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteIndividualsPage_getExpectedActions(Long siteId)
		throws Exception {
	...
	@Test
	public void testGetSiteIndividualsPageWithPagination() throws Exception {
		Long siteId = testGetSiteIndividualsPage_getSiteId();

		Page<Individual> individualsPage =
			individualResource.getSiteIndividualsPage(
				siteId, null, null, null, null, null, null, null, null, null);
		...
		Individual individual3 = testGetSiteIndividualsPage_addIndividual(
			siteId, randomIndividual());
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			Page<Individual> page1 = individualResource.getSiteIndividualsPage(
				siteId, null, null, null, null, null, null, null,
				Pagination.of(
			...
			Page<Individual> page2 = individualResource.getSiteIndividualsPage(
				siteId, null, null, null, null, null, null, null,
				Pagination.of(
			...
			Page<Individual> page3 = individualResource.getSiteIndividualsPage(
				siteId, null, null, null, null, null, null, null,
				Pagination.of(
	...
	@Test
	public void testGetSiteIndividualsPageWithSortDateTime() throws Exception {
		testGetSiteIndividualsPageWithSort(
	...
	@Test
	public void testGetSiteIndividualsPageWithSortDouble() throws Exception {
		testGetSiteIndividualsPageWithSort(
	...
	@Test
	public void testGetSiteIndividualsPageWithSortInteger() throws Exception {
		testGetSiteIndividualsPageWithSort(
	...
	@Test
	public void testGetSiteIndividualsPageWithSortString() throws Exception {
		testGetSiteIndividualsPageWithSort(
	...
	protected void testGetSiteIndividualsPageWithSort(
		...
		individual1 = testGetSiteIndividualsPage_addIndividual(
			siteId, individual1);

		individual2 = testGetSiteIndividualsPage_addIndividual(
			siteId, individual2);
	...
	protected Individual testGetSiteIndividualsPage_addIndividual(
			Long siteId, Individual individual)
		throws Exception {
	...
	protected Long testGetSiteIndividualsPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetSiteIndividualsPage_getIrrelevantSiteId()
		throws Exception {

		return irrelevantGroup.getGroupId();
	}

	protected Individual testGraphQLSiteIndividual_addIndividual()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:505588036