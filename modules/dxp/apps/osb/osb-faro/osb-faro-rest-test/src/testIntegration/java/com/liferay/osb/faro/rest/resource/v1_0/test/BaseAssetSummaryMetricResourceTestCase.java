...
public abstract class BaseAssetSummaryMetricResourceTestCase {
	...
	@Test
	public void testGetSiteAssetSummariesPage() throws Exception {
		Long siteId = testGetSiteAssetSummariesPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteAssetSummariesPage_getIrrelevantSiteId();
		...
		if (irrelevantSiteId != null) {
			AssetSummaryMetric irrelevantAssetSummaryMetric =
				testGetSiteAssetSummariesPage_addAssetSummaryMetric(
					irrelevantSiteId, randomIrrelevantAssetSummaryMetric());

			page = assetSummaryMetricResource.getSiteAssetSummariesPage(
			...
			assertValid(
				page,
				testGetSiteAssetSummariesPage_getExpectedActions(
					irrelevantSiteId));
		}

		AssetSummaryMetric assetSummaryMetric1 =
			testGetSiteAssetSummariesPage_addAssetSummaryMetric(
				siteId, randomAssetSummaryMetric());
		...
		assertValid(
			page, testGetSiteAssetSummariesPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteAssetSummariesPage_getExpectedActions(Long siteId)
		throws Exception {
	...
	@Test
	public void testGetSiteAssetSummariesPageWithPagination() throws Exception {
		Long siteId = testGetSiteAssetSummariesPage_getSiteId();
	...
	@Test
	public void testGetSiteAssetSummariesPageWithSortDateTime()
		throws Exception {

		testGetSiteAssetSummariesPageWithSort(
	...
	@Test
	public void testGetSiteAssetSummariesPageWithSortDouble() throws Exception {
		testGetSiteAssetSummariesPageWithSort(
	...
	@Test
	public void testGetSiteAssetSummariesPageWithSortInteger()
		throws Exception {
	...
	@Test
	public void testGetSiteAssetSummariesPageWithSortString() throws Exception {
		testGetSiteAssetSummariesPageWithSort(
	...
	protected void testGetSiteAssetSummariesPageWithSort(
		...
		assetSummaryMetric1 =
			testGetSiteAssetSummariesPage_addAssetSummaryMetric(
				siteId, assetSummaryMetric1);

		assetSummaryMetric2 =
			testGetSiteAssetSummariesPage_addAssetSummaryMetric(
				siteId, assetSummaryMetric2);
	...
	protected AssetSummaryMetric
			testGetSiteAssetSummariesPage_addAssetSummaryMetric(
				Long siteId, AssetSummaryMetric assetSummaryMetric)
		throws Exception {
	...
	protected Long testGetSiteAssetSummariesPage_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	protected Long testGetSiteAssetSummariesPage_getIrrelevantSiteId()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:1363852471