...
public abstract class BaseIndividualSegmentResourceTestCase {
	...
	@Test
	public void testGetSiteIndividualSegment() throws Exception {
		IndividualSegment postIndividualSegment =
			testGetSiteIndividualSegment_addIndividualSegment();

		IndividualSegment getIndividualSegment =
			individualSegmentResource.getSiteIndividualSegment(
				testGetSiteIndividualSegment_getSiteId(),
	...
	protected Long testGetSiteIndividualSegment_getSiteId() throws Exception {
		return testGroup.getGroupId();
	}

	@Test
	public void testGraphQLGetSiteIndividualSegment() throws Exception {
		IndividualSegment individualSegment =
			testGraphQLGetSiteIndividualSegment_addIndividualSegment();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											"siteKey",
											"\"" +
												testGraphQLGetSiteIndividualSegment_getSiteId() +
													"\"");
										put(
											"individualSegmentId",
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/individualSegment"))));
			...
			equals(
				...
				IndividualSegmentSerDes.toDTO(
					JSONUtil.getValueAsString(
						...
						"Object/individualSegment"))));
	}

	protected Long testGraphQLGetSiteIndividualSegment_getSiteId()
		throws Exception {
	...
	@Test
	public void testGraphQLGetSiteIndividualSegmentNotFound() throws Exception {
	...
	protected IndividualSegment
		...
		return testGraphQLSiteIndividualSegment_addIndividualSegment();
	}

	@Test
	public void testGetSiteIndividualSegmentsPage() throws Exception {
		Long siteId = testGetSiteIndividualSegmentsPage_getSiteId();
		Long irrelevantSiteId =
			testGetSiteIndividualSegmentsPage_getIrrelevantSiteId();
		...
		if (irrelevantSiteId != null) {
			IndividualSegment irrelevantIndividualSegment =
				testGetSiteIndividualSegmentsPage_addIndividualSegment(
					irrelevantSiteId, randomIrrelevantIndividualSegment());

			page = individualSegmentResource.getSiteIndividualSegmentsPage(
			...
			assertValid(
				page,
				testGetSiteIndividualSegmentsPage_getExpectedActions(
					irrelevantSiteId));
		}

		IndividualSegment individualSegment1 =
			testGetSiteIndividualSegmentsPage_addIndividualSegment(
				siteId, randomIndividualSegment());
		...
		assertValid(
			page, testGetSiteIndividualSegmentsPage_getExpectedActions(siteId));
	}

	protected Map<String, Map<String, String>>
			testGetSiteIndividualSegmentsPage_getExpectedActions(Long siteId)
		throws Exception {
	...
	@Test
	public void testGetSiteIndividualSegmentsPageWithPagination()
		throws Exception {
	...
	protected IndividualSegment
			testGetSiteIndividualSegmentsPage_addIndividualSegment(
				Long siteId, IndividualSegment individualSegment)
		throws Exception {
	...
	protected Long testGetSiteIndividualSegmentsPage_getSiteId()
		throws Exception {

		return testGroup.getGroupId();
	}

	protected Long testGetSiteIndividualSegmentsPage_getIrrelevantSiteId()
		throws Exception {
	...
	protected IndividualSegment
			testGraphQLSiteIndividualSegment_addIndividualSegment()
		throws Exception {
...
// LIFERAY-REST-BUILDER-HASH:-2047456679