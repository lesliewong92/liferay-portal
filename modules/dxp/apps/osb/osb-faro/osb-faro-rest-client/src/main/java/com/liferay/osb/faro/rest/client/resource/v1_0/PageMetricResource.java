...
public interface PageMetricResource {
	...
	public static class Builder {
		...
		public PageMetricResource build() {
			return new PageMetricResourceImpl(this);
		}
	...
	public static class PageMetricResourceImpl implements PageMetricResource {
		...
		public Page<PageMetric> getWorkspaceGroupPagesPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getWorkspaceGroupPagesPageHttpResponse(
			...
			try {
				return Page.of(content, PageMetricSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/workspace/{groupId}/pages");
		...
		private PageMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			PageMetricResource.class.getName());
