...
public interface AssetSummaryMetricResource {
	...
	public static class Builder {
		...
		public AssetSummaryMetricResource build() {
			return new AssetSummaryMetricResourceImpl(this);
		}
	...
	public static class AssetSummaryMetricResourceImpl
		...
		public Page<AssetSummaryMetric> getWorkspaceGroupAssetSummariesPage(
			...
			try {
				return Page.of(content, AssetSummaryMetricSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		private AssetSummaryMetricResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AssetSummaryMetricResource.class.getName());
