...
public interface ChannelResource {
	...
	public HttpInvoker.HttpResponse getSiteChannelHttpResponse(
	...
	public HttpInvoker.HttpResponse getSiteChannelsPageHttpResponse(
	...
	public static class ChannelResourceImpl implements ChannelResource {
		...
		public Channel getSiteChannel(Long siteId, String channelId)
			...
			HttpInvoker.HttpResponse httpResponse = getSiteChannelHttpResponse(
				siteId, channelId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/channels/{channelId}");
		...
		public Page<Channel> getSiteChannelsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteChannelsPageHttpResponse(siteId, pagination);
		...
		public HttpInvoker.HttpResponse getSiteChannelsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/channels");
...
// LIFERAY-REST-BUILDER-HASH:453471206