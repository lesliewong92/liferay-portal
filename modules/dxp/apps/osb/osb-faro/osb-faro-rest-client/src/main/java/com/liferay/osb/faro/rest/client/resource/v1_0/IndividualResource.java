...
public interface IndividualResource {
	...
	public HttpInvoker.HttpResponse getSiteIndividualHttpResponse(
			Long siteId, String individualId, String channelId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getSiteIndividualProfileHttpResponse(
			Long siteId, String individualId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getSiteIndividualsPageHttpResponse(
			Long siteId, String accountId, String channelId,
			String dataSourceId, Boolean includeAnonymousUsers,
			String individualSegmentId, String interestName, String search,
			Pagination pagination, String sortString)
	...
	public static class IndividualResourceImpl implements IndividualResource {
		...
		public Individual getSiteIndividual(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteIndividualHttpResponse(siteId, individualId, channelId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/individuals/{individualId}");
		...
		public Individual getSiteIndividualProfile(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteIndividualProfileHttpResponse(siteId, individualId);
		...
		public HttpInvoker.HttpResponse getSiteIndividualProfileHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/individuals/{individualId}/profile");
		...
		public Page<Individual> getSiteIndividualsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteIndividualsPageHttpResponse(
					siteId, accountId, channelId, dataSourceId,
					includeAnonymousUsers, individualSegmentId, interestName,
					search, pagination, sortString);
		...
		public HttpInvoker.HttpResponse getSiteIndividualsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/individuals");
...
// LIFERAY-REST-BUILDER-HASH:2082356303