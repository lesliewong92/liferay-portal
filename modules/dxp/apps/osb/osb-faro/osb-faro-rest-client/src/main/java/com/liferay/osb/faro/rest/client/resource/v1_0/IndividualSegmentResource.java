...
public interface IndividualSegmentResource {
	...
	public HttpInvoker.HttpResponse getSiteIndividualSegmentHttpResponse(
			Long siteId, String individualSegmentId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getSiteIndividualSegmentsPageHttpResponse(
			Long siteId, String channelId, String name, String search,
			String status, Pagination pagination)
		throws Exception;
	...
	public static class IndividualSegmentResourceImpl
		...
		public IndividualSegment getSiteIndividualSegment(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteIndividualSegmentHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/individual-segments/{individualSegmentId}");
		...
		public Page<IndividualSegment> getSiteIndividualSegmentsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteIndividualSegmentsPageHttpResponse(
					siteId, channelId, name, search, status, pagination);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/individual-segments");
...
// LIFERAY-REST-BUILDER-HASH:-1444917156