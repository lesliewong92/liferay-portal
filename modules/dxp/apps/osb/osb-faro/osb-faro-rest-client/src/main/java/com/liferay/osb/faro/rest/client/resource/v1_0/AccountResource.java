...
public interface AccountResource {
	...
	public HttpInvoker.HttpResponse getSiteAccountHttpResponse(
			Long siteId, String accountId)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getSiteAccountsPageHttpResponse(
			Long siteId, String channelId, String search, Pagination pagination,
			String sortString)
		throws Exception;
	...
	public static class AccountResourceImpl implements AccountResource {
		...
		public Account getSiteAccount(Long siteId, String accountId)
			...
			HttpInvoker.HttpResponse httpResponse = getSiteAccountHttpResponse(
				siteId, accountId);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/accounts/{accountId}");
		...
		public Page<Account> getSiteAccountsPage(
				Long siteId, String channelId, String search,
				Pagination pagination, String sortString)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getSiteAccountsPageHttpResponse(
					siteId, channelId, search, pagination, sortString);
		...
		public HttpInvoker.HttpResponse getSiteAccountsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/accounts");
...
// LIFERAY-REST-BUILDER-HASH:1860780878