 ...
 */
@Generated("")
public interface IndividualSegmentMembershipResource {
	...
	public HttpInvoker.HttpResponse
			getSiteIndividualSegmentMembershipsPageHttpResponse(
				Long siteId, String individualSegmentId, Pagination pagination,
				String sortString)
		throws Exception;
	...
	public static class Builder {
		...
		public IndividualSegmentMembershipResource build() {
			return new IndividualSegmentMembershipResourceImpl(this);
		}
	...
	public static class IndividualSegmentMembershipResourceImpl
		implements IndividualSegmentMembershipResource {
		...
		public Page<IndividualSegmentMembership>
			...
			HttpInvoker.HttpResponse httpResponse =
				getSiteIndividualSegmentMembershipsPageHttpResponse(
					siteId, individualSegmentId, pagination, sortString);
			...
			try {
				return Page.of(
					content, IndividualSegmentMembershipSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/sites/{siteId}/individual-segments/{individualSegmentId}/memberships");
		...
		private IndividualSegmentMembershipResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			IndividualSegmentMembershipResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:1471074527