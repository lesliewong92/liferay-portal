...
public interface EventResource {
	...
	public static class Builder {
		...
		public EventResource build() {
			return new EventResourceImpl(this);
		}
	...
	public static class EventResourceImpl implements EventResource {
		...
		public Page<Event> getWorkspaceGroupChannelEventsPage(
			...
			try {
				return Page.of(content, EventSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/faro-rest/v1.0/workspace/{groupId}/channels/{channelId}/events");
		...
		private EventResourceImpl(Builder builder) {
			_builder = builder;
		}
