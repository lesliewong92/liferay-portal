...
@Generated("")
@GraphQLName(
	description = "A saved audience definition that selects Individuals matching a filter expression. Segments are how Faro groups contacts for targeting, reporting, and activation.",
...
public class IndividualSegment implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Number of Individuals currently in the segment whose membership is active."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Number of anonymous (browser-tracked, unidentified) Individuals in this segment."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Identifier of the Channel this segment is scoped to. Cross-channel segments may have a null channelId."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "OData-style filter expression that defines segment membership, e.g. `lastSessionCountry eq 'US' and activitiesCount gt 5`."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Stable Faro-internal segment identifier. Use this with `getIndividualSegment` to fetch a single segment."
	)
	public String getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "True if anonymous (unidentified) Individuals are eligible for membership in this segment."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Total Individuals in the segment, including inactive memberships."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Number of identified (non-anonymous) Individuals in this segment."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Either 'BATCH' (re-evaluated periodically) or 'REAL_TIME' (evaluated on each event)."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Build state of the segment: 'READY', 'IN_PROGRESS', or 'DISABLED'."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Lifecycle status of the segment: 'ACTIVE' or 'INACTIVE'."
	)
...
// LIFERAY-REST-BUILDER-HASH:-2054875131