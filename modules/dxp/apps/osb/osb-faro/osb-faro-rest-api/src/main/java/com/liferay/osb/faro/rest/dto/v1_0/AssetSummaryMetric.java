...
@Generated("")
@GraphQLName(
	description = "An aggregated set of analytics metrics for a single tracked asset (page, blog, document, form, journal, object entry, etc.) over the selected date range. Counts and trends are flattened from the underlying Cerebro Metric tree for LLM-friendly consumption — `*TrendPercentage` fields express change vs. the previous comparable period.",
...
public class AssetSummaryMetric implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Stable Cerebro-internal identifier of the tracked asset."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Percentage change in downloads vs. the previous comparable period. Negative = decrease."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Percentage change in impressions vs. the previous comparable period."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Percentage change in reads vs. the previous comparable period."
	)
...
// LIFERAY-REST-BUILDER-HASH:1176001217