...
@Generated("")
@GraphQLName(
	description = "A single contact (person) tracked by the Faro Contacts engine. Individuals are aggregated from website visitors, CRM contacts, and other data sources, and may be either 'known' (identified by email/account) or 'anonymous' (browser-tracked only).",
	value = "Individual"
)
...
public class Individual implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Display name of the Account this Individual is primarily associated with, when known."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Total number of tracked activities (page views, events, etc.) attributed to this Individual."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "First time this Individual was observed by the Contacts engine."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Last time this Individual's profile was modified by the Contacts engine (data import, profile merge, attribute update)."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Stable Faro-internal Individual identifier. Use this with `getIndividual` to fetch a single Individual."
	)
	public String getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Country (ISO name) detected for the Individual's most recent session, derived from IP geolocation when available."
	)
...
// LIFERAY-REST-BUILDER-HASH:812594773