...
@Generated("")
@GraphQLName(
	description = "A single tracked analytics event captured by the Cerebro engine — page views, custom events, form submissions, etc. Each event carries free-form `attributes` (a name→value map of contextual properties) plus any matching page metadata. To list events for a channel, use `getChannelEventsPage`.",
	value = "Event"
)
...
public class Event implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Identifier of the application that emitted the event (e.g. the Cerebro analytics app)."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Title of the asset associated with the event, when applicable."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Free-form event properties as a name→value map. Keys are property names defined in EventAttributeDefinition; values are stringified per their underlying data type. (Mapped from the engine's repeated `properties: [{name, value}]` shape.)"
	)
	@Valid
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Canonical URL of the page where the event was emitted, normalized for analytics joining."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Timestamp when the event was recorded by the engine."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "SHA-256 hash of the originating individual's email address, when known. Used for joining without leaking PII. Null for anonymous individuals."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Event name as defined in EventDefinition (e.g. 'pageView', 'formSubmit', custom names)."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Meta description of the page that emitted the event, when present."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Meta keywords of the page that emitted the event, comma-separated when multiple."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Title of the page that emitted the event."
	)
	...
	@GraphQLField(description = "Title of the page that emitted the event.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Referring URL the visitor arrived from, when known."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Actual URL of the page where the event was emitted (may differ from canonicalUrl)."
	)
...
// LIFERAY-REST-BUILDER-HASH:209454517