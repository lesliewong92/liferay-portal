...
@Generated("")
@GraphQLName(
	description = "A single Individual's membership in an IndividualSegment. Captures when the Individual entered the segment and (if applicable) when they exited.",
...
// LIFERAY-REST-BUILDER-HASH:1823208792