...
@Generated("")
@GraphQLName(
	description = "A B2B account (company) tracked by the Faro Contacts engine. Accounts aggregate Individuals (contacts) employed by or associated with a single organization.",
	value = "Account"
)
...
public class Account implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Display name of the account (company name)."
	)
	...
	@GraphQLField(description = "Display name of the account (company name).")
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Annual revenue of the account, when known. Currency is implied by the source data and not normalized."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "ISO country name (not code) where the account is headquartered, when known."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Last time the account record was modified in the Contacts engine."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Stable Faro-internal account identifier. Use this with `getAccount` to fetch the account directly."
	)
	public String getId() {
		if (_idSupplier != null) {
			id = _idSupplier.get();
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Industry classification of the account, e.g. 'Software', 'Manufacturing'. Free-form text from the upstream data source."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Most recent activity from any Individual associated with this account."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Sales/marketing lifecycle stage of the account, e.g. 'Prospect', 'Customer'. Source-dependent."
	)
...
// LIFERAY-REST-BUILDER-HASH:1386756444