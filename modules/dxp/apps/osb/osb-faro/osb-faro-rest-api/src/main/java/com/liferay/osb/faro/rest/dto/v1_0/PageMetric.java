...
@Generated("")
@GraphQLName(
	description = "Analytics metrics for a single tracked Page over the selected date range. Aggregates view, visitor, bounce, and access-path metrics flattened from the Cerebro engine's Metric tree. Use `getSitePagesPage` to list these for a site.",
	value = "PageMetric"
)
...
public class PageMetric implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Stable Cerebro-internal identifier of the page."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Always 'PAGE' for results from this endpoint."
	)
	...
	@GraphQLField(description = "Always 'PAGE' for results from this endpoint.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Fraction (0–1) of sessions that landed on this page and exited without further interaction."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Visit count where this page was the entry point with no referrer (direct URL)."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Total entrance count: sessions that started on this page (regardless of access type)."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Fraction (0–1) of sessions on which this page was the last page viewed before exit."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "All distinct URLs that resolve to this page (canonical plus alternates), within the selected date range."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Percentage change in views vs. the previous comparable period."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Distinct visitor count (deduplicated by individual or session) over the date range."
	)
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "Percentage change in distinct visitors vs. the previous comparable period."
	)
...
// LIFERAY-REST-BUILDER-HASH:70340691