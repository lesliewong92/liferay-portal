...
public abstract class BaseAssetSummaryMetricResourceImpl
	implements AssetSummaryMetricResource, EntityModelResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/sites/{siteId}/asset-summaries'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "AssetSummaryMetric")
		}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/asset-summaries")
...
// LIFERAY-REST-BUILDER-HASH:-602373774