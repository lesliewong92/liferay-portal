...
public abstract class BaseIndividualSegmentMembershipResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/sites/{siteId}/individual-segments/{individualSegmentId}/memberships'  -u 'test@liferay.com:test'
	 */
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path(
		"/sites/{siteId}/individual-segments/{individualSegmentId}/memberships"
	)
...
// LIFERAY-REST-BUILDER-HASH:1906640042