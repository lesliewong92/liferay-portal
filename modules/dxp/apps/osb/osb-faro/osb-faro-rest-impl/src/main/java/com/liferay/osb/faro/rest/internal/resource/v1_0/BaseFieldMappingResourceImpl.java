...
public abstract class BaseFieldMappingResourceImpl
	implements FieldMappingResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/sites/{siteId}/field-mappings/{fieldMappingId}'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "FieldMapping")}
	)
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/field-mappings/{fieldMappingId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public FieldMapping getSiteFieldMapping(
			...
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("fieldMappingId")
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/faro-rest/v1.0/sites/{siteId}/field-mappings'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/field-mappings")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<FieldMapping> getSiteFieldMappingsPage(
			...
			String context,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("ownerType")
			String ownerType,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseFieldMappingResourceImpl.class);

}
// LIFERAY-REST-BUILDER-HASH:-563882301