...
public class IndividualDemographicFieldDTOConverter
	...
	public IndividualDemographicField toDTO(
		DTOConverterContext dtoConverterContext, Field engineField) {
		...
		return new IndividualDemographicField() {
			{
				setFieldType(engineField::getFieldType);
				setLabel(engineField::getLabel);
				setName(engineField::getName);
				setValue(engineField::getValue);
			}
		};
	}
