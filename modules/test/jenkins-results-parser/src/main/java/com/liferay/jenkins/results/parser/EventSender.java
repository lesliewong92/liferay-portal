...
public class EventSender {
	...
	protected void notify(String eventName, Build build) {
	...
	protected void subscribe(String eventName, EventListener eventListener) {
		List<EventListener> eventListenerList = _eventListeners.get(eventName);
	...
	protected void unsubscribe(String eventName, EventListener eventListener) {
		List<EventListener> eventListenerList = _eventListeners.get(eventName);
